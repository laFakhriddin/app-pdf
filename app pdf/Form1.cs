    ...
    public partial class Form1 : Form
    {
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            ...
            using (os)
            {
                ...
                PdfPCell row3 = new PdfPCell(new Phrase("Berildi   " + textBox1.Text + "   yilda tug’ilgan talaba", f_15_normal));
                PdfPCell cel4 = new PdfPCell(new Phrase("VAZIRLIGI", f_15_bold));
                PdfPCell row4 = new PdfPCell(new Phrase(textBox2.Text, f_15_normal));
                PdfPCell cel5 = new PdfPCell(new Phrase("TOSHKENT DAVLAT", f_15_bold));
                PdfPCell row5 = new PdfPCell(new Phrase("" + textBox12.Text[6] + textBox12.Text[7] + textBox12.Text[8] + textBox12.Text[9] + " yil “ " + textBox12.Text[0] + textBox12.Text[1] + " ”  " + textBox12.Text[3] + textBox12.Text[4] + "  kundagi  " + textBox11.Text + "  sonli buyruq asosida Toshkent Davlat", f_15_normal));
                PdfPCell cel6 = new PdfPCell(new Phrase("TRANSPORT", f_15_bold));
                PdfPCell row6 = new PdfPCell(new Phrase("Transport Universitetiga o\'qishga kirdi va xozirgi kunda " +textBox19.Text+"bosqich ", f_15_normal));
                PdfPCell cel7 = new PdfPCell(new Phrase("UNIVERSITETI", f_15_bold));
                PdfPCell row7 = new PdfPCell(new Phrase("talabasi hisoblanadi va o\'qish davri 01.07.20________ yilgacha davom etadi.", f_15_normal));
                PdfPCell cel8 = new PdfPCell(new Phrase("100167, Toshkent shahar,", f_15_bold));
                PdfPCell row8 = new PdfPCell(new Phrase("Ushbu ma\'lumot" + textBox10.Text, f_15_normal));
                ...
                PdfPCell cel11 = new PdfPCell(new Phrase("No: " + pri1.ToString(), f_15_bold));
                PdfPCell row11 = new PdfPCell(new Phrase("Talabaning manzili: " + textBox3.Text, f_15_normal));

                PdfPCell cel12 = new PdfPCell(new Phrase("“" + dy + "”-" + mn + "-" + yy + " ", f_15_bold));
                PdfPCell row12 = new PdfPCell(new Phrase(" ", f_15_normal));
                PdfPCell cel13 = new PdfPCell(new Phrase("Telefon (71) 299-02-98", f_15_bold));
                PdfPCell row13 = new PdfPCell(new Phrase("M.O`.                              Rektor                          O.Q.Abduraxmanov", f_15_bold));
                ...
                PdfPCell row32 = new PdfPCell(new Phrase("Berildi   " + textBox6.Text + "   yilda tug’ilgan talaba", f_15_normal));
                PdfPCell cel42 = new PdfPCell(new Phrase("VAZIRLIGI", f_15_bold));
                PdfPCell row42 = new PdfPCell(new Phrase(textBox5.Text, f_15_normal));
                PdfPCell cel52 = new PdfPCell(new Phrase("TOSHKENT DAVLAT", f_15_bold));
                PdfPCell row52 = new PdfPCell(new Phrase("20____yil “_____” ______sonli___________buyruq asosida Toshkent Davlat", f_15_normal));
                PdfPCell cel62 = new PdfPCell(new Phrase("TRANSPORT", f_15_bold));
                PdfPCell row62 = new PdfPCell(new Phrase("Transport Universitetiga o\'qishga kirdi va xozirgi kunda ___________bosqich ", f_15_normal));
                PdfPCell cel72 = new PdfPCell(new Phrase("UNIVERSITETI", f_15_bold));
                PdfPCell row72 = new PdfPCell(new Phrase("talabasi hisoblanadi va o\'qish davri 01.07.20________ yilgacha davom etadi.", f_15_normal));
                PdfPCell cel82 = new PdfPCell(new Phrase("100167, Toshkent shahar,", f_15_bold));
                PdfPCell row82 = new PdfPCell(new Phrase("Ushbu ma\'lumot _________________________________________________", f_15_normal));
                ...
                PdfPCell cel121 = new PdfPCell(new Phrase("No: " + pri2.ToString(), f_15_bold));
                PdfPCell row121 = new PdfPCell(new Phrase("Talabaning manzili: " + textBox4.Text, f_15_normal));

                PdfPCell cel122 = new PdfPCell(new Phrase("“" + dy + "”-" + mn + "-" + yy + " ", f_15_bold));
                ...
                PdfPCell row123 = new PdfPCell(new Phrase("M.O`.                              Rektor                          O.Q.Abduraxmanov", f_15_bold));
                ...
                PdfPCell row33 = new PdfPCell(new Phrase("Berildi   " + textBox9.Text + "   yilda tug’ilgan talaba", f_15_normal));
                PdfPCell cel43 = new PdfPCell(new Phrase("VAZIRLIGI", f_15_bold));
                PdfPCell row43 = new PdfPCell(new Phrase(textBox8.Text, f_15_normal));
                PdfPCell cel53 = new PdfPCell(new Phrase("TOSHKENT DAVLAT", f_15_bold));
                PdfPCell row53 = new PdfPCell(new Phrase("20____yil “_____” ______sonli___________buyruq asosida Toshkent Davlat", f_15_normal));
                PdfPCell cel63 = new PdfPCell(new Phrase("TRANSPORT", f_15_bold));
                PdfPCell row63 = new PdfPCell(new Phrase("Transport Universitetiga o\'qishga kirdi va xozirgi kunda ___________bosqich ", f_15_normal));
                PdfPCell cel73 = new PdfPCell(new Phrase("UNIVERSITETI", f_15_bold));
                PdfPCell row73 = new PdfPCell(new Phrase("talabasi hisoblanadi va o\'qish davri 01.07.20________ yilgacha davom etadi.", f_15_normal));
                PdfPCell cel83 = new PdfPCell(new Phrase("100167, Toshkent shahar,", f_15_bold));
                PdfPCell row83 = new PdfPCell(new Phrase("Ushbu ma\'lumot _________________________________________________", f_15_normal));
                ...
                PdfPCell cel131 = new PdfPCell(new Phrase("No: " + pri3.ToString(), f_15_bold));
                PdfPCell row131 = new PdfPCell(new Phrase("Talabaning manzili: " + textBox7.Text, f_15_normal));

                PdfPCell cel132 = new PdfPCell(new Phrase("“" + dy + "”-" + mn + "-" + yy + " ", f_15_bold));
                ...
                PdfPCell row133 = new PdfPCell(new Phrase("M.O`.                              Rektor                          O.Q.Abduraxmanov", f_15_bold));
        ...
        private void Checker()
        {
            ...
            if (textBox2.Text.Length == 0)
                textBox2.Text = "_______________________________________________________________";
            if (textBox3.Text.Length == 0)
                textBox3.Text = "______________________________________________";
            if (textBox4.Text.Length == 0)
                textBox4.Text = "______________________________________________";
            if (textBox5.Text.Length == 0)
                textBox5.Text = "______________________________________________________________";
            if (textBox6.Text.Length == 0)
                textBox6.Text = "___________";
            if (textBox7.Text.Length == 0)
                textBox7.Text = "______________________________________________";
            if (textBox8.Text.Length == 0)
                textBox8.Text = "______________________________________________________________";
            if (textBox9.Text.Length == 0)
                textBox9.Text = "___________";


            if (textBox10.Text.Length == 0)
                textBox10.Text = "___________";
            if (textBox11.Text.Length == 0)
                textBox11.Text = "_______________________________________________________________";
            if (textBox12.Text.Length == 0)
                textBox12.Text = "______________________________________________";
            if (textBox13.Text.Length == 0)
                textBox13.Text = "______________________________________________";
            if (textBox14.Text.Length == 0)
                textBox14.Text = "______________________________________________________________";
            if (textBox15.Text.Length == 0)
                textBox15.Text = "___________";
            if (textBox16.Text.Length == 0)
                textBox16.Text = "______________________________________________";
            if (textBox17.Text.Length == 0)
                textBox17.Text = "______________________________________________________________";
            if (textBox18.Text.Length == 0)
                textBox18.Text = "___________";
        }
