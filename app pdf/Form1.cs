    ...
    public partial class Form1 : Form
    {
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            ...
            using (os)
            {
                ...
                PdfPCell row13 = new PdfPCell(new Phrase("M.O`.                              Rektor                                     " + textBox28.Text, f_15_bold));
                ...
                PdfPCell row123 = new PdfPCell(new Phrase("M.O`.                              Rektor                                   " + textBox28.Text, f_15_bold));
                ...
                PdfPCell row133 = new PdfPCell(new Phrase("M.O`.                              Rektor                                    " + textBox28.Text, f_15_bold));
        ...
        private void Checker()
        {
            ...
            if (textBox28.Text.Length == 0)
                textBox28.Text = "         O.K.Abduraxmanov";
        }
